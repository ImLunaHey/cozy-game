...
type CauliflowerProps = {
  x: number;
  y: number;
};

export class Cauliflower extends Entity {
  constructor({ x, y }: CauliflowerProps) {
    super('Cauliflower', [
      ...
      new Asset({
        height: 32,
        width: 16,
        src: '/assets/farming/crops/ground/cauliflower/cauliflower_crop_lifecycle.png',
        offsets: {
          x: 0,
          y: 0,
        },
